        ...
        .then((response) => {
            ...
            response.data.forEach(pizza => {
                ...
                <tr>
                    ...
                    <td><a class="btn btn-primary" href="./show.html?id=${pizza.id}"><i class="fa-solid fa-magnifying-glass"></i></a></td>
                    <td><a class="btn btn-primary" href="/api/pizze/edit/${pizza.id}"><i class="fa-regular fa-pen-to-square"></i></a></td>
                    <td>
